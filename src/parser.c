...
enum ts_symbol_identifiers {
  ...
  sym_interpreted_string_literal = 29,
  sym_list_expression = 30,
  sym_map_expression = 31,
  sym__colon_property = 32,
  aux_sym_source_file_repeat1 = 33,
  aux_sym_interpreted_string_literal_repeat1 = 34,
  aux_sym_list_expression_repeat1 = 35,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 26:
      ...
      if (sym_identifier_character_set_3(lookahead)) ADVANCE(33);
      END_STATE();
    case 27:
      ACCEPT_TOKEN(sym_identifier);
      if (lookahead == 'e') ADVANCE(34);
      if (sym_identifier_character_set_4(lookahead)) ADVANCE(33);
      END_STATE();
    case 28:
      ACCEPT_TOKEN(sym_identifier);
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 4),
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 2),
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 5, .production_id = 4),
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2),
  [39] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(45),
  [42] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expr, 1),
  [44] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean_literal, 1),
  [46] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 5),
  [48] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer_literal, 1),
  [50] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__string_literal, 1),
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 4, .production_id = 2),
  [54] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 3, .production_id = 2),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer_literal, 2),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 3),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpreted_string_literal, 2),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 4, .production_id = 4),
  [66] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 2),
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpreted_string_literal, 3),
  ...
  [80] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 2), SHIFT_REPEAT(34),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 2),
  [85] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 2), SHIFT_REPEAT(34),
  [88] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [90] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [92] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_map_expression_repeat1, 2, .production_id = 5), SHIFT_REPEAT(46),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_map_expression_repeat1, 2, .production_id = 5),
  ...
  [107] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 1),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 1),
  [111] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [113] = {.entry = {.count = 1, .reusable = true}}, SHIFT(23),
  [115] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_list_expression_repeat1, 2), SHIFT_REPEAT(5),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_list_expression_repeat1, 2),
  ...
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__colon_property, 3, .production_id = 3),
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_map_expression_repeat1, 2, .production_id = 2),

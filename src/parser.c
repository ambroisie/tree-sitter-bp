...
enum ts_symbol_identifiers {
  ...
  sym_identifier = 5,
  anon_sym_DASH = 6,
  aux_sym_integer_literal_token1 = 7,
  ...
  sym_list_expression = 27,
  sym_map_expression = 28,
  sym__colon_property = 29,
  aux_sym_source_file_repeat1 = 30,
  aux_sym_interpreted_string_literal_repeat1 = 31,
  aux_sym_list_expression_repeat1 = 32,
  aux_sym_map_expression_repeat1 = 33,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [29] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 4),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpreted_string_literal, 3),
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 5, .production_id = 4),
  ...
  [42] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 5),
  [44] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer_literal, 1),
  [46] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__string_literal, 1),
  [48] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 4, .production_id = 4),
  [50] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 4, .production_id = 2),
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 3, .production_id = 2),
  [54] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_integer_literal, 2),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 3),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpreted_string_literal, 2),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_map_expression, 2),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 2),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1),
  [66] = {.entry = {.count = 1, .reusable = false}}, SHIFT(47),
  [68] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 2), SHIFT_REPEAT(36),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 2),
  [73] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 2), SHIFT_REPEAT(36),
  ...
  [92] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_map_expression_repeat1, 2, .production_id = 5), SHIFT_REPEAT(45),
  ...
  [107] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_list_expression_repeat1, 2), SHIFT_REPEAT(5),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_list_expression_repeat1, 2),
  [112] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 1),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 1),
  ...
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__colon_property, 3, .production_id = 3),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 3, .production_id = 1),
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_map_expression_repeat1, 2, .production_id = 2),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__definition, 1),
  ...
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 2),
};

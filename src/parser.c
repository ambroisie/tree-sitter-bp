...
enum ts_symbol_identifiers {
  ...
  sym_interpreted_string_literal = 23,
  sym_list_expression = 24,
  aux_sym_source_file_repeat1 = 25,
  aux_sym_interpreted_string_literal_repeat1 = 26,
  aux_sym_list_expression_repeat1 = 27,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [34] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpreted_string_literal, 3),
  [36] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 2),
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 5),
  [40] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expr, 1),
  [42] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list_expression, 4),
  ...
  [60] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 2), SHIFT_REPEAT(23),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 2),
  [65] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 2), SHIFT_REPEAT(23),
  ...
  [76] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 1),
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_interpreted_string_literal_repeat1, 1),
  [80] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [82] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_list_expression_repeat1, 2), SHIFT_REPEAT(6),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_list_expression_repeat1, 2),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__definition, 1),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 1),
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 3, .production_id = 1),
